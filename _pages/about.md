...
The course assumes a strong working knowledge of linear algebra, probability, and Python programming. Prior experience with machine learning, signal processing, or image processing is recommended but not required. See the course [logistics](logistics/) page for additional details.

---
- **Time:** Tuesday/Thursday 2:30PM -- 3:45PM
- **Location:** Computer Science Building, W150
- **Discussion:** [Piazza](https://piazza.com/umass/fall2026/compsci670/home)
- **Homework:** release [Moodle](https://umass.moonami.com/course/view.php?id=32814), submission: [Gradescope]()
- **Contact:** Please post course-related questions on
  [Piazza](https://piazza.com/umass/fall2026/compsci670/home), where
  we will also post announcements. For external
  enquiries, personal matters, or emergencies, email the instructor.
